...
public class CplexModelGenerator7 {
	//IloCplex cplexModel;
	...
	public CplexModelGenerator7(ILPPreprocessor ilpPr, 
			Map<OWLClassExpression, Set<OWLClassExpression>> conceptSubsumersMap,
		...
		//	System.out.println("final relaxed_opt " + relaxed_opt);
			if( relaxed_opt < M ){
				...
				//	System.out.println("constraint size " + orgConstraint.length);
					...
					returnSolution = applyBranchAndPrice(-1, rmpModel, ppModel, rmpCplex, ppCplex, x, h,subsets, b, r, sr, rmpModel.Constraint);
					rmpCplex.end();
					ppCplex.end();

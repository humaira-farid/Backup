...
public class CplexModelGenerator11 {
	//IloCplex cplexModel;
	...
	public CplexModelGenerator11(ILPPreprocessor ilpPr, 
		...
		/// Generating new columns ///
			...
			//			System.err.println(reducedCost.toString() +"  "+ ppCplex.getObjValue());
						...
						for(int j = 0 ; j < newCol.length ; j++) {
							System.out.println("r v  ["+j +"]"+ newCol[j]);
			...
			//			System.err.println("cost " + cost + " cost2 "+cost2 +" (cost*cost)*bPlus "+ (cost*cost)*bPlus + " square bPlus "+bPlus*bPlus);
						IloColumn column = rmpCplex.column(obj, cost2);//Creates and returns a column from the specified objective and value.

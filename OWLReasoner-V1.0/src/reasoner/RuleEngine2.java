...
public class RuleEngine2 {
	...
	public RuleEngine2(Internalization i, ToDoList todo, OWLDataFactory df, Configuration config) {
		this.intl= i;
		this.todo = todo;
...
/*	private void applyAllGeneratingRules(Node node) {
	...
	class BranchHandler{
	    ...
	    public void checkAboxConsistency(Set<OWLSubClassOfAxiom> aboxClassAss, OWLClassExpression tgAxiom) {
			...
			//	System.out.println("individual "+ asb.getSubClass());
	 ...
	 public int indLeft(Set<OWLSubClassOfAxiom> set) {
